...
const Nav = () => {
    return (
        <>
            <div className="free flex justify-between bg-[#0f020b] px-10 py-5">
                <div className='flex'>
                    ...
                    <div className='shopping flex gap-4'>
                    <form>   
                ...
                <div className='social_icons text-[#edfb13] mt-4 flex text-xl gap-2'>
                    <AiOutlineHeart />
                    <BsBagCheck />
                    <div className='account'>
                        ...
                        <p className='text-sm flex'>User name</p>
                    </div>
                </div>
                    </div>
            </div>
            <div className="main_hd">
                <div className="shopping_content flex justify-between">
                    ...
                    <div className="">
                        ...
                        <div className='social_icons mt-4 flex text-xl gap-2'>
